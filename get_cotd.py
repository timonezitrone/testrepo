...
api_key = 'AIzaSyDV2C2NTLtRuhPYM6A8cpRYaeqVS_mViYA'
...
def commit_and_push_changes():
    try:
        ...
        subprocess.run(["git", "add", "challenge_of_the_day/"], check=True)
...
def get_challenge_of_the_day(api_key, grid):
    ...
    while found_image == False and count < 100:
        ...
        count += 1
    if image_path:
      	commit_and_push_changes(image_path)  # Push the new image to GitHub
